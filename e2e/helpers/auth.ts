...
export async function signInWithSession(page: Page, username: "e2e_reception" | "e2e_supervisor" | "e2e_super_admin" | "e2e_doctor" | "e2e_doctor_other" | "e2e_doctor_non_supervisor") {
