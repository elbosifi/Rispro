      ...
      <PatientSearch
        ...
        onSelect={(patient) => {
          onSelectPatient({
            ...
            primaryIdentifierType: patient.primaryIdentifierType,
            primaryIdentifierTypeLabelAr: patient.primaryIdentifierTypeLabelAr,
            primaryIdentifierTypeLabelEn: patient.primaryIdentifierTypeLabelEn,
