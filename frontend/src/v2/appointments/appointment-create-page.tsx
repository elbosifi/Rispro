...
export function AppointmentCreatePage() {
  ...
  const initialSelectedPatient: SelectedPatient | null = preloadPatientQuery.data
    ? {
        ...
        primaryIdentifierType: preloadPatientQuery.data[1].primaryIdentifierType,
        primaryIdentifierTypeLabelAr: preloadPatientQuery.data[1].primaryIdentifierTypeLabelAr,
        primaryIdentifierTypeLabelEn: preloadPatientQuery.data[1].primaryIdentifierTypeLabelEn,
        nationalId: null,
