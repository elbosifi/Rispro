...
function fixture(state: "healthy" | "degraded" | "offline" | "disabled" = "healthy") {
  return {
    ...
    jobs: { error: null, summary: { total: 3, running: 1, pending: 0, failed: 1, successful: 1, paused: 0, recentRelevantFailed: state === "degraded" ? 1 : 0, recentFailureWindowHours: 24 }, items: [
