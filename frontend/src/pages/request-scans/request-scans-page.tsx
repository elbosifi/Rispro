...
function RequestScanRow({ language, job, showClinicalExport, canRetryClinicalExports, showSelection, selected, canRetryArchives, openMenu, onSelect, onToggleMenu, onCloseMenu, onPreview, onDetails, onRetryArchive, onRetryClinicalExport, onRetry, onAssign, onAppointment, retryPending }: { language: Language; job: Job; showClinicalExport: boolean; canRetryClinicalExports: boolean; showSelection: boolean; selected: boolean; canRetryArchives: boolean; openMenu: boolean; onSelect: (checked: boolean) => void; onToggleMenu: () => void; onCloseMenu: () => void; onPreview: () => void; onDetails: () => void; onRetryArchive: () => void; onRetryClinicalExport: () => void; onRetry: () => void; onAssign: () => void; onAppointment: () => void; retryPending: boolean }) {
