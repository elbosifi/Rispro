...
export type ComplementaryRecall = { id: number; originalAppointmentId: number; recallAppointmentId: number | null; receptionInstruction: string | null; technologistInstruction: string; status: "pending_scheduling" | "scheduled" | "completed" | "cancelled"; requestedByUserId: number; requestedAt: string; receptionSeenAt: string | null; scheduledAt: string | null; completedAt: string | null; cancelledAt: string | null; patientDisplayName?: string | null; patientMrn?: string | null; patientIdentifier?: string | null; originalAccession?: string; originalExam?: string | null; modalityName?: string | null; modalityCode?: string | null; requesterDisplayName?: string | null; recallAppointmentAccession?: string | null; recallAppointmentDate?: string | null; };
