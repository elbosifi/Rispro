...
export async function updateDoctorLinkedUserForAdmin(userId: number, payload: { username: string; email: string; fullName: string; englishName?: string | null; coreRole: "doctor" | "supervisor"; active: boolean }): Promise<{ user: User; profile: DoctorProfile }> {
...
export async function refreshReportingBoardCaseSonicDicomStatus(appointmentId: number): Promise<{ ok: true; appointmentId: number; successful: boolean; previousStatus: string; reportStatus: string; changed: boolean; cachedStatusRetained: boolean; checkedAt: string }> {
...
function mapComparisonRequest(raw: RawRecord): ComparisonRequest {
  return {
    ...
    materialsConfirmedByNameAr: rawString(raw.materialsConfirmedByNameAr),
    materialsConfirmedByNameEn: rawString(raw.materialsConfirmedByNameEn),
    materialsConfirmedByUsername: rawString(raw.materialsConfirmedByUsername),
    ...
    createdByNameAr: rawString(raw.createdByNameAr),
    createdByNameEn: rawString(raw.createdByNameEn),
    createdByUsername: rawString(raw.createdByUsername),
    createdAt: String(raw.createdAt ?? ""),
    updatedAt: String(raw.updatedAt ?? ""),
    cancelledBy: rawNumber(raw.cancelledBy),
    cancelledByName: rawString(raw.cancelledByName),
    cancelledByNameAr: rawString(raw.cancelledByNameAr),
    cancelledByNameEn: rawString(raw.cancelledByNameEn),
    cancelledByUsername: rawString(raw.cancelledByUsername),
    ...
    preparationReturnedByNameAr: rawString(raw.preparationReturnedByNameAr),
    preparationReturnedByNameEn: rawString(raw.preparationReturnedByNameEn),
    preparationReturnedByUsername: rawString(raw.preparationReturnedByUsername),
