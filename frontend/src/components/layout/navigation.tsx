...
export const NAV_ITEMS: NavItemConfig[] = [
  ...
  { route: "legacy-viewer", labelKey: "nav.legacyViewer", icon: "legacy" },
...
function NavIconGlyph({ icon }: { icon: NavIcon }) {
  ...
  switch (icon) {
    ...
    case "legacy":
      return <svg {...common}><path strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" d="M4 7h16M4 12h16M4 17h10M4 21h6" /><rect x="2" y="3" width="20" height="18" rx="2" strokeWidth={2} fill="none" /></svg>;
  }
}
