...
export interface PatientIdentityReconciliationSummary { id: number; status: string; oldPatientId: string | null; operationType: string; failureCode: string | null; }
export interface ProtocolingPatientHistoryItem { appointmentId: number | null; orthancStudyId: string | null; studyInstanceUid: string | null; accessionNumber: string | null; date: string | null; time: string | null; modalities: string[]; description: string | null; appointmentStatus: string | null; reportAvailable: boolean; source: ProtocolingHistorySource; identityDiscrepancy: "patient_id_mismatch" | null; historicalPatientId?:string|null; historicalPatientName?:string|null; historicalPatientBirthDate?:string|null; reconciliation?:PatientIdentityReconciliationSummary|null; }
export type HistoricalPacsMatchClassification = "exact" | "strong_demographic" | "possible" | "ambiguous";
export type HistoricalPacsIndexStatus = "ready" | "stale" | "unavailable" | "uninitialized";
export interface HistoricalPacsPatientAttestation { studyInstanceUid: string; status: "confirmed" | "denied"; recordedByUserId: number; recordedByName: string | null; recordedAt: string; }
export interface HistoricalPacsStudy { orthancStudyId: string; studyInstanceUid: string | null; accessionNumber: string | null; patientId: string | null; patientName: string | null; patientBirthDate: string | null; patientSex: string | null; studyDate: string | null; studyDescription: string | null; modalitiesInStudy: string[]; seriesCount: number; instanceCount: number; reconciliation?:PatientIdentityReconciliationSummary|null; attestation?: HistoricalPacsPatientAttestation | null; }
