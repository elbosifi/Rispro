  ...
  const result = await db.query<ReportingBoardCaseRow>(
    `
      select
        ...
        cta.expected_reporting_date::text as "dueAt",
        ...
        manual_final.created_by_doctor_id as "manualFinalByDoctorId",
...
function reportingBoardCaseRow(row: ReportingBoardCaseRow): ReportingBoardCaseRow {
  return {
    ...
    manualFinalByDoctorId: nullableNumber(row.manualFinalByDoctorId),
