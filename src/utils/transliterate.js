...
/**
 * Deterministic Arabic-to-Latin transliteration for patient names.
 * Supports common Arabic characters with their Latin equivalents.
 * This is a simple character-by-character mapping, not a true translation.
 */
...
/**
 * Transliterate an Arabic name to a Latin-character approximation.
 * @param {string} arabicName
 * @returns {string}
 */
export function transliterateArabicName(arabicName) {
