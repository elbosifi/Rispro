...
export interface NationalIdDemographics {
  sex?: 'M' | 'F';
  estimatedDateOfBirth?: string;
  ageYears?: number;
}

export function deriveDemographicsFromNationalId(nationalId: string): NationalIdDemographics {
  const result: NationalIdDemographics = {};
