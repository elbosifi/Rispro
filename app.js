...
const copy = {
  ...
  ar: {
    ...
    appSubtitle: "نظام إدارة قسم الأشعة",
    topTitle: "المركز الوطني للأورام بنغازي",
    topSubtitle: "أدوات تسجيل المرضى، جدولة المواعيد، والإشراف في قسم الأشعة.",
    ...
    nav: {
      ...
      calendar: "التقويم",
      registrations: "المواعيد",
      queue: "قائمة الإنتظار",
      modality: "صفحة الأجهزة",
      doctor: "لوحة الطبيب",
      print: "الطباعة",
    ...
    dashboard: {
      ...
      body: "فحص سريع للحالة مع متابعة قائمة اليوم ومراجعة عدم الحضور.",
      primary: "تسجيل مريض",
      secondary: "البحث عن مريض",
      next7Title: "الحالات خلال 7 أيام",
      next7Note: "المواعيد المسجلة خلال الأسبوع القادم.",
      next30Title: "الحالات خلال 30 يوماً",
      next30Note: "المواعيد المسجلة خلال الشهر القادم.",
      avgNextSlotTitle: "متوسط أقرب موعد",
      nextSlotTitle: "أقرب موعد متاح لكل جهاز",
      nextSlotNote: "عدد الأيام حتى أقرب موعد متاح.",
      nextSlotUnavailable: "لا توجد مواعيد خلال 30 يوماً",
      daysLabel: "أيام",
      todayLabel: "اليوم",
    ...
    queue: {
      ...
      body: "امسح رقم الدخول لليوم، وتابع المرضى المنتظرين، وأضف المرضى المباشرين مباشرة إلى القائمة الاستقبال.",
      ...
      walkInButton: "إضافة المريض المباشر للقائمة",
...
const SETTINGS_META = {
  ...
  queue_and_arrival: {
    ...
    fields: {
      ...
      walk_in_queue: { en: "Walk-in queue", ar: "إضافة مريض مباشر للقائمة" },
...
function formatAuditActionType(value) {
  const labels = {
    ...
    scan_into_queue: { en: "Scan into queue", ar: "دخول قائمة الانتظار" },
...
async function updateSelectedAppointment() {
  ...
  try {
    ...
    const needsReauth = isSupervisorReauthNeededForOverbooking(error);
    if (needsReauth) {
      const credentials = await openOverbookingApprovalModal(payload);
